...
public class StationBlockEntity extends BlockEntity {
    ...
    // Direction label for this stop (e.g. "Northbound"), shown verbatim on the HUD leaving here; otherwise the train shows its compass heading of travel.
    ...
    // Stored upper-case so a direction label is always all-caps (e.g. "NORTHBOUND") whatever the source.
